	...
	public sealed class Action : IAction
	{
		...
		public string BookmarkLink
		{
			get
			{
				...
				{
					CalendarData.CalendarDiagContext.Fail("BookmarkLink is undefined for this Action");
					return null;
				}
		...
		public string HyperLink
		{
			get
			{
				...
				{
					CalendarData.CalendarDiagContext.Fail("Hyperlink is undefined for this Action");
					return null;
				}
		...
		public IDrillthrough Drillthrough
		{
			get
			{
				...
				{
					CalendarData.CalendarDiagContext.Fail("Drillthgough is undefined for this Action");
					return null;
				}
