...
namespace GrapeCity.ActiveReports.Calendar.Design.SmartPanels.Controls
{
	...
	internal class VisibilityEditor : VerticalPanel
	{
		...
		private sealed class VisibilityWrapper
		{
			...
			{
				DiagContext.Designer.Assert(visibility != null, "Visibility is null!");
				DiagContext.Designer.Assert(reportItem != null, "Report item is null!");
			...
			private IComponentChangeService ComponentChangeService
			{
				get
				{
					if (_componentChangeService == null)
					{
						...
						if (_componentChangeService == null)
						{
							DiagContext.Designer.Fail(typeof(IComponentChangeService) + " is not available.");
						}
					}
