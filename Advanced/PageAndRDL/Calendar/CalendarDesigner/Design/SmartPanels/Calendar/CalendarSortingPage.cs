...
namespace GrapeCity.ActiveReports.Calendar.Design.SmartPanels.Calendar
{
	...
	internal class CalendarSortingPage : CalendarPageBase
	{
		...
		{
			DiagContext.Designer.Assert(Designer.ReportItem.CustomData != null, "CustomData should be initialized.");
			DiagContext.Designer.Assert(Designer.ReportItem.CustomData.DataRowGroupings.Count == 1, "Only one data grouping is allowed.");
