...
Public NotInheritable Class RtfDesigner
	...
	Public Overrides Sub Initialize(component As IComponent)
		...
		SetRtf(GetCustomPropertyAsString(RTF_FIELD_NAME))
	End Sub
	...
	Public Property CanGrow As Boolean
		Get
			Return GetCustomPropertyAsBoolean(CAN_GROW_FIELD_NAME, False)
		End Get
		Set
			SetCustomProperty(CAN_GROW_FIELD_NAME, value.ToString())
		End Set
	End Property
	...
	Public Property CanShrink As Boolean
		Get
			Return GetCustomPropertyAsBoolean(CAN_SHRINK_FIELD_NAME, False)
		End Get
		Set
			SetCustomProperty(CAN_SHRINK_FIELD_NAME, value.ToString())
		End Set
	End Property
	...
	Private Function GetCustomPropertyAsString(propertyName As String) As String
		Dim customProperty = ReportItem.CustomProperties(propertyName)
		If customProperty IsNot Nothing Then Return customProperty.Value.ToString()
		Return String.Empty
	End Function

	Private Function GetCustomPropertyAsBoolean(propertyName As String, defaultValue As Boolean) As Boolean
		Dim customProperty = ReportItem.CustomProperties(propertyName)
		If customProperty IsNot Nothing Then Return Convert.ToBoolean(customProperty.Value.ToString())
		Return defaultValue
	End Function

	Private Sub SetCustomProperty(name As String, value As ExpressionInfo)
		Dim customProperty = ReportItem.CustomProperties(name)
		If customProperty IsNot Nothing Then ReportItem.CustomProperties.Remove(customProperty)
		ReportItem.CustomProperties.Add(New CustomPropertyDefinition(name, value))
	End Sub
