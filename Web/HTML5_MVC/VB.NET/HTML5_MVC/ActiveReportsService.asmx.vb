...
Imports GrapeCity.ActiveReports.Samples.HTML5_MVC.Models
...
Public Class ActiveReportsService
	...
	Protected Overrides Function OnCreateReportHandler(reportPath As String) As Object
		Dim data As String() = reportPath.Split(";"c)
		...
		Select Case data(0)
			Case "Section"
				...
				report.LoadLayout(XmlReader.Create(Server.MapPath("~/Reports/OrderReport.rpx")))
				...
				Return report
			Case "Page"
				Dim report As PageReport = New PageReport(New FileInfo(Server.MapPath("~/Reports/OrderDetailsReport.rdlx")))
