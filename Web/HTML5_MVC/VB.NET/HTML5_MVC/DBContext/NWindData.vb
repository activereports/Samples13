	...
	Public NotInheritable Class NWindData
		...
		Public Shared Function GetNWindCustomers() As List(Of Customer)
			If Customers Is Nothing Then
				...
				Dim conn As New OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\evan.warren\Documents\GrapeCity Samples\ActiveReports 13\Data\NWIND.mdb;Persist Security Info=False")
				conn.Open()
