@Code
    ViewBag.Title = "ActiveReports with AngularJS"
End Code
...
@section scripts
    ...
    <script type="text/javascript">
        ...
        function checkActive(e) {
            ...
            $(e.target).addClass('list-item--active');
            refreshviewer();
        }
...
<body id="mainbody" data-ng-app="testapp" data-ng-controller="CustomerController">
    <!-- Navigation -->
    <div class="headerdiv">
        <img src="~/Content/Images/reels_logo.png" />  ActiveReports with AngularJS
        ...
        <div class="mainleft">
            ...
            <form class="navbar-form" role="search">
                ...
                <table id="tabmenu">
                    ...
                    <tr data-ng-repeat="(key, customer) in customers | filter:searchText ">
                        <td>
                            <a onclick="checkActive(event)" data-ng-click="CustomerDetail(customer)" ng-class="{'list-item--active': !key}" href="javascript:;" class="list-item">
