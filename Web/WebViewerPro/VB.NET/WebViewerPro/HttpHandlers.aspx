<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="HttpHandlers.aspx.vb" Inherits="GrapeCity.ActiveReports.Samples.Web.HttpHandlers" %>
            ...
            <div>
                <p>
                    ...
                    <p>
                        For example:</p>
                    <ul>
                        <li><a href="http://localhost:4707/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.CodeReports.Invoice.ActiveReport?OutputFormat=PDF">
                        ...
                        <li><a href="http://localhost:4707/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.CodeReports.NwindLabels.ActiveReport?OutputFormat=HTML">
                    ...
                    <ul>
                        <li><a href="http://localhost:4707/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.CodeReports.InvoiceFiltered.ActiveReport?StartingDate=1994-9-1&EndingDate=1994-9-5">
                        ...
                        <li><a href="http://localhost:4707/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.CodeReports.NwindLabelsFiltered.ActiveReport?Country=USA">
