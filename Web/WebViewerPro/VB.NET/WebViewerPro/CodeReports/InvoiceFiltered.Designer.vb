Namespace CodeReports
	...
	Partial Public Class InvoiceFiltered
		...
		Private Sub InitializeComponent()
			...
			OleDBDataSource1.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\evan.warren\Documents\GrapeCity Samples\ActiveReports 13\Data\Nwind.mdb;Persist Security I" &
	"nfo=False"
			OleDBDataSource1.SQL = "SELECT * FROM Invoices " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE ((OrderDate >= #<%StartingDate|Starting Date:|1994" &
	"-8-1|D%>#) AND (OrderDate <= #<%EndingDate|Ending Date:|1994-9-1|D%>#))" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "ORDER B" &
	"Y OrderID"
