...
namespace ODataDataSource
{
	...
	public partial class MainForm : Form
	{
		...
		{
			if (args.DataSet.Name == "Years") // ObjectsReport <entext>:bind collection to report</entext>
			{
				args.Data = _dataList;
			}
			else if (args.DataSet.Name == "Movies") // SubObjectsReport <entext>:bind subcollection to subreport</entext>
			{
